...
public class Main extends JFrame {
    ...
    private void initComponents() {
        ...
        JPanel DialogBlankPanel = new JPanel();
        ...
        ButtonPanel.setBorder(new LineBorder(new Color(115, 41, 41), 2, true));
        ButtonPanel.setForeground(new Color(242, 242, 242));
        ButtonPanel.setPreferredSize(new Dimension(235, 242));
        ...
        PasswordManagerLabel.setText("<html> <center> Password <br> Manager </center> </html>");
        PasswordManagerLabel.setToolTipText("");
        PasswordManagerLabel.setEnabled(false);

        buttonSetup(EncrypterButton, this::EncrypterButtonActionPerformed);
        buttonSetup(DecrypterButton, this::DecrypterButtonActionPerformed);
        buttonSetup(SettingsButton, this::SettingsButtonActionPerformed);
        buttonSetup(LogHistoryButton, this::LogHistoryButtonActionPerformed);
        buttonSetup(EulaAndCreditsButton, this::EulaAndCreditsButtonActionPerformed);
        ...
        ProgramPanelLayout.setHorizontalGroup(
                ProgramPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(ProgramPanelLayout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(ButtonPanel, GroupLayout.PREFERRED_SIZE, 240,
                ...
                ProgramPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(ProgramPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(ProgramPanelLayout
                                        ...
                                        .addComponent(ButtonPanel, GroupLayout.DEFAULT_SIZE, 240,
                                                Short.MAX_VALUE)
                                        .addComponent(DialogPanel, GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(5, 5, 5)));
    ...
    private static void buttonSetup(JButton Button, ActionListener ActionListener) {
