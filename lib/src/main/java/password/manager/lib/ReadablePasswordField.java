...
public class ReadablePasswordField extends AnchorPane implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        this.prefWidthProperty().addListener((obs, oldValue, newValue) -> {
        ...
        this.prefHeightProperty().addListener((obs, oldValue, newValue) -> {
        ...
        readable.addListener((obs, oldValue, newValue) -> {
            if (newValue) {
        ...
        imageView.addEventFilter(MouseEvent.MOUSE_PRESSED, event -> toggleReadable());
